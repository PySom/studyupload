...
namespace StudyMATEUpload.Migrations
{
    ...
    [Migration("20200615070915_IAmScared")]
    partial class IAmScared
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.LearnCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.UserLearnCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.UserQuiz", b =>
                {
                    ...
                    b.Property<int?>("UserLearnCourseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.Quiz", b =>
                {
                    b.HasOne("StudyMATEUpload.Models.LearnCourse", "LearnCourse")
                        .WithMany("Quizzes")
                        .HasForeignKey("LearnCourseId");
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.UserQuiz", b =>
                {
                    ...
                    b.HasOne("StudyMATEUpload.Models.UserLearnCourse", "UserLearnCourse")
                        .WithMany("UserQuizzes")
                        .HasForeignKey("UserLearnCourseId");
                });
            ...
            modelBuilder.Entity("StudyMATEUpload.Models.UserVideo", b =>
                {
                    b.HasOne("StudyMATEUpload.Models.UserLearnCourse", "UserCourse")
                        .WithMany("UserVideos")
                        .HasForeignKey("UserCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
